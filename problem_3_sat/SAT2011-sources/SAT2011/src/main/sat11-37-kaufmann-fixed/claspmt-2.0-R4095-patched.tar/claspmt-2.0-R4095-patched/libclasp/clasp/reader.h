...
public:
	...
	virtual bool   read(Solver& s, ApiPtr api, int numModels) = 0;
...
public:
	...
	bool   read(Solver& s, ApiPtr api, int numModels);
 ...
 * \param ctx The context object in which to store variables
