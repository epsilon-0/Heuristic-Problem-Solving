...
private:
	...
	friend struct mt::Shared_WeightConstraintLits;
	uint32   size_   : 30; // number of lits in constraint (counting the literal associated with the constraint)
	uint32   shared_ :  1; // if 1  this object is actually part of a Shared_WeightConstraintLits object
...
public:
	 ...
	 * to 1.
	 */
	static bool newWeightConstraint(Solver& s, Literal W, WeightLitVec& lits, weight_t bound, Constraint** out = 0);
...
private:
	WeightConstraint(Solver& s, Literal W, const WeightLitVec& lits, uint32 bound, uint32 sumW);
