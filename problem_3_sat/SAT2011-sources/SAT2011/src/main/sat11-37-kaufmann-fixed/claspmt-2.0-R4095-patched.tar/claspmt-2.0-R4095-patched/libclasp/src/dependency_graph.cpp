...
/////////////////////////////////////////////////////////////////////////////////////////
// class Shared_DependencyGraph
/////////////////////////////////////////////////////////////////////////////////////////
Shared_DependencyGraph::Shared_DependencyGraph() {
}
Shared_DependencyGraph::~Shared_DependencyGraph() {
...
bool Shared_DependencyGraph::relevantPrgAtom(const Solver& s, PrgAtomNode* a) const { 
	return !s.isFalse(a->literal()) && a->scc() != PrgNode::noScc;
}
bool Shared_DependencyGraph::relevantPrgBody(const Solver& s, PrgBodyNode* b) const { 
...
void Shared_DependencyGraph::addSccs(SharedContext& ctx, const AtomList& sccAtoms, const AtomList& prgAtoms, const BodyList& prgBodies) {
	...
	for (AtomList::size_type i = 0, end = sccAtoms.size(); i != end; ++i) {
		...
		if (relevantPrgAtom(*ctx.master(), a)) { 
			...
			temp      = std::copy(succsExt.begin(), succsExt.end(), temp);
			preds.clear(); succs.clear(); succsExt.clear();
		}
	}	
}

uint32 Shared_DependencyGraph::addBody(SharedContext& ctx, PrgBodyNode* b, const AtomList& prgAtoms) {
