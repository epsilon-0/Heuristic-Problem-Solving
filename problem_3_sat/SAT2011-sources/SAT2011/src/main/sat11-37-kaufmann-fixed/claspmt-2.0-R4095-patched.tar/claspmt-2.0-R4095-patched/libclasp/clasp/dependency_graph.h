...
public:
   ...
   */
	struct BodyNode : public Node {
		 ...
		 */
		const NodeId* preds() const { return sep_; }
...
private:
	Shared_DependencyGraph(const Shared_DependencyGraph&);
	Shared_DependencyGraph& operator=(const Shared_DependencyGraph&);
