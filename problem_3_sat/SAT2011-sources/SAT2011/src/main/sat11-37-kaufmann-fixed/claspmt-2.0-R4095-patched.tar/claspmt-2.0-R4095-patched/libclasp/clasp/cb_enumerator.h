...
namespace Clasp { namespace mt { class SharedLiterals; }
class ClauseHead;
...
public:
	...
	public:
		...
		virtual ClauseHead*         set(Solver& s, const LitVec& c) = 0;
		virtual mt::SharedLiterals* getShared()                     = 0;
	};
	/*!
...
private:
	struct CBConstraint : public SolveConstraint {
		...
		bool integrate(Solver& s, mt::SharedLiterals* lits);
		ConstraintDB locked;
	};
